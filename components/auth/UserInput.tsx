...
const UserInput = ({value,onChangeText,inputBoxStyle,inputTopic,authBox,isEyeNeeded,passwordVisible,togglePasswordVisibility}) => {
  ...
  return (
    <>
        ...
        <TextInput value={value} onChangeText={onChangeText} style={[inputBoxStyle,{width:isEyeNeeded?'80%':'100%'}]}  placeholderTextColor='#adb5bd' secureTextEntry={isEyeNeeded?passwordVisible:false} />
        {
            isEyeNeeded?(
