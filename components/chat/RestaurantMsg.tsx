...
const RestaurantMsg = () => {
    return (
        <View style={{ height: height * 0.08, width: width, backgroundColor: 'white', alignItems: 'center', justifyContent: 'flex-start', flexDirection: 'row', gap: 10, paddingHorizontal: 10 }}>
